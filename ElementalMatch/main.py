...
def main():
    ...
    # Load the sounds.
    GAMESOUNDS = {}
    #GAMESOUNDS['badswap'] = pygame.mixer.Sound('../TestWork/badswap.wav')
    GAMESOUNDS['match'] = []
...
def Splashs():
    ...
    pygame.time.wait(5000)  # places teh screen on a timer (miliseconds)
...
def FireLevel():
    ...
    while True:  # main game loop
        ...
        DrawScore(str("Score:") + str(score) + str("    ") + str("Lvl:") + str(2) + str("  ") + str("    ") + str(
            "Moves:") + str(movee) + str("   ") + str("HS:") + str(11))
        pygame.display.update()
        FPSCLOCK.tick(FPS)
        # under main loop
...
def IceLevel():
    ...
    while True:  # main game loop
        ...
        DrawScore(str("Score:") + str(score) + str("    ") + str("Lvl:") + str(3) + str("  ") + str("    ") + str(
            "Moves:") + str(movee) + str("   ") + str("HS:") + str(17))
        pygame.display.update()
        FPSCLOCK.tick(FPS)
